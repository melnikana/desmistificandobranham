            ...
            {getPageNumbers().map((page, index) => {
              ...
              return (
                <Button
                  ...
                  className={cn(
                    "rounded-none",
                    currentPage === page && "z-10 bg-primary text-primary-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  )}
